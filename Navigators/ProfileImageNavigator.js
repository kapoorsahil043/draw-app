...
import ProfileImageView from "../Screens/User/ProfileImageView"
...
function MyStack(props) {
    ...
    const activeHeaderStyleForViewImage = () => {
        return {headerTintColor:"white",headerStyle: {backgroundColor: constants.COLOR_BLACK}}
    }

    return (
        <Stack.Navigator>
            <Stack.Screen name="Profile Image"component={ProfileImage} options={activeHeaderStyle}/>
            <Stack.Screen name="View Image"component={ProfileImageView} options={activeHeaderStyleForViewImage}/>
        </Stack.Navigator>
    )
}

export default function ProfileImageNavigator(props) {
